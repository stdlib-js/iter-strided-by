...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/iter-strided-by/tags). For example,

```javascript
iterStridedBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-strided-by@v0.2.0-umd/browser.js' )
```
